 ...
 */
@Entity
@Table(name = "type_charact", schema = "public", catalog = "DbFD")
public class TypeCharactEntity {
    private int id;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        TypeCharactEntity that = (TypeCharactEntity) o;
    ...
    @OneToMany(mappedBy = "typeCharactByIdTypeCharact")
